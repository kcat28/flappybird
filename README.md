...
Recreating Flappy Bird for fun (and brushing JavaScript skills).

## Overview
A lightweight recreation of the classic game built with plain JavaScript and the HTML5 Canvas API.  
